...
contract VaultManager {
	...
	function deposit(uint256 vaultAssets1, uint256 vaultAssets2, address receiver) public returns (DepositResult memory result) {
        ...
        (result.amountA, result.amountB, result.liquidity) = IUniswapV2Router(
            ROUTER
        ).addLiquidity(
            vault1.asset(),
            vault2.asset(),
